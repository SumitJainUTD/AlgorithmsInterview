...
public class InOrderSuccessor {
	public TreeNode findInOrderSuccessor(TreeNode root, TreeNode x) {
		// if the right child of x is not null then in-Order successor will the
		// left most node in
	...
	public static void main(String args[]) {
		...
		if (x != null) {
			System.out.println("InOrder Successor of " + a.data + " is "
					+ x.data);
		} else {
		...
		if (x != null) {
			System.out.println("InOrder Successor of " + root.data + " is "
					+ x.data);
		} else {
			System.out
					.println("InOrder Successor of " + root.data + " is NULL");
		}
	}
